...
require_once('lib/Decompte.class.php');
...
class Facture{
   ...
   /*
    * Enregistre que le client comme est déjà adhérent
    */
   ...
   /*
    * Enregistre une commande de figurine.
    * à invoquer une fois pour chaque figurine commandée
    */
   ...
   /*
    * produit la chaîne HTML représentant la facture.
    */
